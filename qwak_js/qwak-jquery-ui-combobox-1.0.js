/*
 * Code taken from jQuery autocomplete combobox demo page. All right go to jQuery team.
 *
    ...
    $.widget("ui.combobox", {
        _create: function () {
            ...
            input = $("<input>").appendTo(wrapper).val(value)
                .addClass("ui-state-default ui-combobox-input").autocomplete({
                    delay: 0,
                    minLength: 0,
            ...
            $("<a>").attr("tabIndex", -1).attr("title", "Show All Items")
                ...
                .addClass("ui-corner-right ui-combobox-toggle").click(function () {
